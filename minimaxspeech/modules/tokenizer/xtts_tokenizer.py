...
# -*- encoding: utf-8 -*-
"""
Reference: https://github.com/coqui-ai/TTS/blob/dev/TTS/tts/layers/xtts/tokenizer.py
"""
import logging
import os
import re
...
class VoiceBpeTokenizer:
    ...
    def check_input_length(self, txt, lang):
        ...
        if len(txt) > limit:
            logging.warning(f"The text length: {len(txt)} > limit: {limit} for language '{lang}', text: {txt}")
